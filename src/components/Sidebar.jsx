 ...
 * Sidebar.jsx
 * ───────────────────────────────────────────────────────
 * Left-side frozen navigation for desktop.
 ...
 *   • Social links    → edit SOCIAL_LINKS array
 */
...
const RESUME_HREF     = '/resume.pdf'          // place resume.pdf in /public/
    ...
    <>
      <aside className="sidebar">
        ...
        <button
          ...
          style={{ marginLeft: 'auto', background: 'none', border: '1px solid var(--border)', borderRadius: 8, padding: '0.4rem', color: 'var(--text-muted)', cursor: 'pointer' }}
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            ...
            <div style={{ marginTop: '2rem', display: 'flex', gap: '0.625rem', alignItems: 'center' }}>
              {SOCIAL_LINKS.map(({ label, href, icon }) => (
                <a
                  key={label}
                  href={href}
